  ...
  try {
    const result = streamText({
      ...
      system:
        ...
        "If the browser opens with a setup wizard, YOU MUST IGNORE IT. " +
        "CRITICAL: When interacting with the browser's address bar or search bar, you MUST ensure that any existing text (such as 'chrome://blank') is completely selected or cleared before you start typing a new URL or search query.",
